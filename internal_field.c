...
#define __PYX_HAVE__internal_field
#define __PYX_HAVE_API__internal_field
/* Early includes */
#include "math.h"
#include "pythread.h"
#include <string.h>
...
static double (*__pyx_f_5scipy_7special_14cython_special_lpmv)(double, double, double, int __pyx_skip_dispatch); /*proto*/

/* Module declarations from 'cython.view' */

/* Module declarations from 'cython' */

/* Module declarations from 'internal_field' */
...
static PyObject *__pyx_f_14internal_field_internal_field(double, double, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_14internal_field_internal_field_1darray(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "internal_field"
extern int __pyx_module_is_main_internal_field;
int __pyx_module_is_main_internal_field = 0;

/* Implementation of 'internal_field' */
...
static PyObject *__pyx_pf_14internal_field_internal_field(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_r, double __pyx_v_theta, double __pyx_v_phi, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_sch); /* proto */
static PyObject *__pyx_pf_14internal_field_2internal_field_1darray(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, __Pyx_memviewslice __pyx_v_theta, __Pyx_memviewslice __pyx_v_phi, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_sch); /* proto */
...
static PyObject *__pyx_pw_14internal_field_1internal_field(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_14internal_field_internal_field(double __pyx_v_r, double __pyx_v_theta, double __pyx_v_phi, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_sch, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_max_degree;
  double __pyx_v_field[3];
  int __pyx_v_n;
  int __pyx_v_m;
  double __pyx_v_b_r;
  double __pyx_v_b_t;
  double __pyx_v_b_ph;
  double __pyx_v_legendre;
  double __pyx_v_legendre_d1;
  double __pyx_v_start_mult_r;
  double __pyx_v_start_mult_t;
  double __pyx_v_start_mult_ph;
  double __pyx_v_cos_th;
  double __pyx_v_one_minus;
  double __pyx_v_cos_mphi[0x64];
  double __pyx_v_sin_mphi[0x64];
  double __pyx_v_prev_legendres[0x64];
  ...
  __Pyx_RefNannySetupContext("internal_field", 0);

  /* "internal_field.pyx":15
 * cpdef internal_field(double r, double theta, double phi, double[:,:] g, double[:,:] h, double[:,:] sch):
 * 
 *     cdef Py_ssize_t max_degree = g.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double[3] field
 * 
 */
  __pyx_v_max_degree = (__pyx_v_g.shape[0]);

  /* "internal_field.pyx":24
 ...
 */
  __pyx_t_1 = (__pyx_v_max_degree + 1);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_m = __pyx_t_3;

    /* "internal_field.pyx":25
 * 
 *     for m in range(max_degree + 1):
 *         cos_mphi[m] = cos(m * phi)             # <<<<<<<<<<<<<<
 *         sin_mphi[m] = sin(m * phi)
 *         prev_legendres[m] = 0
 */
    (__pyx_v_cos_mphi[__pyx_v_m]) = cos((__pyx_v_m * __pyx_v_phi));

    /* "internal_field.pyx":26
 *     for m in range(max_degree + 1):
 *         cos_mphi[m] = cos(m * phi)
 *         sin_mphi[m] = sin(m * phi)             # <<<<<<<<<<<<<<
 *         prev_legendres[m] = 0
 * 
 */
    (__pyx_v_sin_mphi[__pyx_v_m]) = sin((__pyx_v_m * __pyx_v_phi));

    /* "internal_field.pyx":27
 *         cos_mphi[m] = cos(m * phi)
 *         sin_mphi[m] = sin(m * phi)
 *         prev_legendres[m] = 0             # <<<<<<<<<<<<<<
 * 
 *     prev_legendres[0] = 1
 */
    (__pyx_v_prev_legendres[__pyx_v_m]) = 0.0;
  }

  /* "internal_field.pyx":29
 *         prev_legendres[m] = 0
 * 
 *     prev_legendres[0] = 1             # <<<<<<<<<<<<<<
 * 
 *     b_r = 0
 */
  (__pyx_v_prev_legendres[0]) = 1.0;

  /* "internal_field.pyx":31
 *     prev_legendres[0] = 1
 * 
 *     b_r = 0             # <<<<<<<<<<<<<<
 *     b_t = 0
 ...
 */
  __pyx_v_start_mult_r = ((1.0 / __pyx_v_r) / __pyx_v_r);

  /* "internal_field.pyx":36
 * 
 *     start_mult_r = 1 / r / r
 *     start_mult_t = sin(theta) / r / r             # <<<<<<<<<<<<<<
 *     start_mult_ph = - 1 / sin(theta) / r / r
 * 
 */
  __pyx_v_start_mult_t = ((sin(__pyx_v_theta) / __pyx_v_r) / __pyx_v_r);

  /* "internal_field.pyx":37
 *     start_mult_r = 1 / r / r
 *     start_mult_t = sin(theta) / r / r
 *     start_mult_ph = - 1 / sin(theta) / r / r             # <<<<<<<<<<<<<<
 * 
 *     cos_th = cos(theta)
 */
  __pyx_v_start_mult_ph = (((-1.0 / sin(__pyx_v_theta)) / __pyx_v_r) / __pyx_v_r);

  /* "internal_field.pyx":39
 *     start_mult_ph = - 1 / sin(theta) / r / r
 * 
 *     cos_th = cos(theta)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_cos_th = cos(__pyx_v_theta);

  /* "internal_field.pyx":40
 * 
 *     cos_th = cos(theta)
 *     one_minus = 1 / (1 - cos_th * cos_th)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_one_minus = (1.0 / (1.0 - (__pyx_v_cos_th * __pyx_v_cos_th)));

  /* "internal_field.pyx":42
 *     one_minus = 1 / (1 - cos_th * cos_th)
 * 
 *     for n in range(1, max_degree + 1):             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_v_start_mult_r = (__pyx_v_start_mult_r / __pyx_v_r);

    /* "internal_field.pyx":44
 *     for n in range(1, max_degree + 1):
 *         start_mult_r = start_mult_r / r
 *         start_mult_t = start_mult_t / r             # <<<<<<<<<<<<<<
 *         start_mult_ph = start_mult_ph / r
 *         for m in range(n + 1):
 */
    __pyx_v_start_mult_t = (__pyx_v_start_mult_t / __pyx_v_r);

    /* "internal_field.pyx":45
 *         start_mult_r = start_mult_r / r
 *         start_mult_t = start_mult_t / r
 *         start_mult_ph = start_mult_ph / r             # <<<<<<<<<<<<<<
 *         for m in range(n + 1):
 ...
 */
    __pyx_v_start_mult_ph = (__pyx_v_start_mult_ph / __pyx_v_r);

    /* "internal_field.pyx":46
 *         start_mult_t = start_mult_t / r
 *         start_mult_ph = start_mult_ph / r
 *         for m in range(n + 1):             # <<<<<<<<<<<<<<
 *                 legendre =  sp.lpmv(m, n, cos_th)
 ...
 */
      __pyx_v_legendre = __pyx_f_5scipy_7special_14cython_special_lpmv(__pyx_v_m, __pyx_v_n, __pyx_v_cos_th, 0);

      /* "internal_field.pyx":48
 *         for m in range(n + 1):
 *                 legendre =  sp.lpmv(m, n, cos_th)
 *                 legendre_d1 = ((n + m) * prev_legendres[m] - n * cos_th * legendre) * one_minus             # <<<<<<<<<<<<<<
 *                 prev_legendres[m] = legendre
 *                 legendre *= sch[n - 1, m]
 */
      __pyx_v_legendre_d1 = ((((__pyx_v_n + __pyx_v_m) * (__pyx_v_prev_legendres[__pyx_v_m])) - ((__pyx_v_n * __pyx_v_cos_th) * __pyx_v_legendre)) * __pyx_v_one_minus);

      /* "internal_field.pyx":49
 *                 legendre =  sp.lpmv(m, n, cos_th)
 *                 legendre_d1 = ((n + m) * prev_legendres[m] - n * cos_th * legendre) * one_minus
 *                 prev_legendres[m] = legendre             # <<<<<<<<<<<<<<
 *                 legendre *= sch[n - 1, m]
 ...
 */
      (__pyx_v_prev_legendres[__pyx_v_m]) = __pyx_v_legendre;

      /* "internal_field.pyx":50
 *                 legendre_d1 = ((n + m) * prev_legendres[m] - n * cos_th * legendre) * one_minus
 *                 prev_legendres[m] = legendre
 *                 legendre *= sch[n - 1, m]             # <<<<<<<<<<<<<<
 *                 legendre_d1 *= sch[n - 1, m]
 ...
 */
      ...
      __pyx_t_8 = __pyx_v_m;
      __pyx_v_legendre = (__pyx_v_legendre * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sch.data + __pyx_t_7 * __pyx_v_sch.strides[0]) ) + __pyx_t_8 * __pyx_v_sch.strides[1]) ))));

      /* "internal_field.pyx":51
 *                 prev_legendres[m] = legendre
 *                 legendre *= sch[n - 1, m]
 *                 legendre_d1 *= sch[n - 1, m]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_legendre_d1 = (__pyx_v_legendre_d1 * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sch.data + __pyx_t_9 * __pyx_v_sch.strides[0]) ) + __pyx_t_10 * __pyx_v_sch.strides[1]) ))));

      /* "internal_field.pyx":53
 *                 legendre_d1 *= sch[n - 1, m]
 * 
 *                 b_r = b_r + start_mult_r * (n + 1) * legendre * (g[n - 1,m] * cos_mphi[m] + h[n - 1,m] * sin_mphi[m])             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_v_b_r = (__pyx_v_b_r + (((__pyx_v_start_mult_r * (__pyx_v_n + 1)) * __pyx_v_legendre) * (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_g.data + __pyx_t_11 * __pyx_v_g.strides[0]) ) + __pyx_t_12 * __pyx_v_g.strides[1]) ))) * (__pyx_v_cos_mphi[__pyx_v_m])) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_h.data + __pyx_t_13 * __pyx_v_h.strides[0]) ) + __pyx_t_14 * __pyx_v_h.strides[1]) ))) * (__pyx_v_sin_mphi[__pyx_v_m])))));

      /* "internal_field.pyx":54
 * 
 *                 b_r = b_r + start_mult_r * (n + 1) * legendre * (g[n - 1,m] * cos_mphi[m] + h[n - 1,m] * sin_mphi[m])
 *                 b_t = b_t + start_mult_t * legendre_d1 * (g[n - 1,m] * cos_mphi[m] + h[n - 1,m] * sin_mphi[m])             # <<<<<<<<<<<<<<
 *                 b_ph = b_ph + start_mult_ph * legendre * m * (-g[n - 1,m] * sin_mphi[m] + h[n - 1,m] * cos_mphi[m])
 ...
 */
      ...
      __pyx_v_b_t = (__pyx_v_b_t + ((__pyx_v_start_mult_t * __pyx_v_legendre_d1) * (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_g.data + __pyx_t_15 * __pyx_v_g.strides[0]) ) + __pyx_t_16 * __pyx_v_g.strides[1]) ))) * (__pyx_v_cos_mphi[__pyx_v_m])) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_h.data + __pyx_t_17 * __pyx_v_h.strides[0]) ) + __pyx_t_18 * __pyx_v_h.strides[1]) ))) * (__pyx_v_sin_mphi[__pyx_v_m])))));

      /* "internal_field.pyx":55
 *                 b_r = b_r + start_mult_r * (n + 1) * legendre * (g[n - 1,m] * cos_mphi[m] + h[n - 1,m] * sin_mphi[m])
 *                 b_t = b_t + start_mult_t * legendre_d1 * (g[n - 1,m] * cos_mphi[m] + h[n - 1,m] * sin_mphi[m])
 *                 b_ph = b_ph + start_mult_ph * legendre * m * (-g[n - 1,m] * sin_mphi[m] + h[n - 1,m] * cos_mphi[m])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_b_ph = (__pyx_v_b_ph + (((__pyx_v_start_mult_ph * __pyx_v_legendre) * __pyx_v_m) * (((-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_g.data + __pyx_t_19 * __pyx_v_g.strides[0]) ) + __pyx_t_20 * __pyx_v_g.strides[1]) )))) * (__pyx_v_sin_mphi[__pyx_v_m])) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_h.data + __pyx_t_21 * __pyx_v_h.strides[0]) ) + __pyx_t_22 * __pyx_v_h.strides[1]) ))) * (__pyx_v_cos_mphi[__pyx_v_m])))));
    }
  }

  /* "internal_field.pyx":57
 *                 b_ph = b_ph + start_mult_ph * legendre * m * (-g[n - 1,m] * sin_mphi[m] + h[n - 1,m] * cos_mphi[m])
 * 
 *     field[0] = b_r             # <<<<<<<<<<<<<<
 *     field[1] = b_t
 *     field[2] = b_ph
 */
  (__pyx_v_field[0]) = __pyx_v_b_r;

  /* "internal_field.pyx":58
 * 
 *     field[0] = b_r
 *     field[1] = b_t             # <<<<<<<<<<<<<<
 *     field[2] = b_ph
 * 
 */
  (__pyx_v_field[1]) = __pyx_v_b_t;

  /* "internal_field.pyx":59
 *     field[0] = b_r
 *     field[1] = b_t
 *     field[2] = b_ph             # <<<<<<<<<<<<<<
 * 
 *     return field
 */
  (__pyx_v_field[2]) = __pyx_v_b_ph;

  /* "internal_field.pyx":61
 *     field[2] = b_ph
 * 
 *     return field             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_23 = __Pyx_carray_to_py_double(__pyx_v_field, 3); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 61, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("internal_field.internal_field", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_14internal_field_1internal_field(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14internal_field_1internal_field(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_r;
  double __pyx_v_theta;
  double __pyx_v_phi;
  __Pyx_memviewslice __pyx_v_g = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_h = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_sch = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("internal_field (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_r,&__pyx_n_s_theta,&__pyx_n_s_phi,&__pyx_n_s_g,&__pyx_n_s_h,&__pyx_n_s_sch,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_theta)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("internal_field", 1, 6, 6, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_phi)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field", 1, 6, 6, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_g)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field", 1, 6, 6, 3); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field", 1, 6, 6, 4); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sch)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field", 1, 6, 6, 5); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "internal_field") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_r = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_r == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_theta = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_theta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_phi = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_phi == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_g = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_g.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_h = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_h.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_sch = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sch.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("internal_field", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("internal_field.internal_field", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14internal_field_internal_field(__pyx_self, __pyx_v_r, __pyx_v_theta, __pyx_v_phi, __pyx_v_g, __pyx_v_h, __pyx_v_sch);
...
static PyObject *__pyx_pf_14internal_field_internal_field(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_r, double __pyx_v_theta, double __pyx_v_phi, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_sch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("internal_field", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_g.memview)) { __Pyx_RaiseUnboundLocalError("g"); __PYX_ERR(0, 13, __pyx_L1_error) }
  if (unlikely(!__pyx_v_h.memview)) { __Pyx_RaiseUnboundLocalError("h"); __PYX_ERR(0, 13, __pyx_L1_error) }
  if (unlikely(!__pyx_v_sch.memview)) { __Pyx_RaiseUnboundLocalError("sch"); __PYX_ERR(0, 13, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14internal_field_internal_field(__pyx_v_r, __pyx_v_theta, __pyx_v_phi, __pyx_v_g, __pyx_v_h, __pyx_v_sch, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_sch, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "internal_field.pyx":63
 *     return field
 * 
 * cpdef internal_field_1darray(double[:] r, double[:] theta, double[:] phi, double[:,:] g, double[:,:] h, double[:,:] sch):             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_14internal_field_3internal_field_1darray(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_14internal_field_internal_field_1darray(__Pyx_memviewslice __pyx_v_r, __Pyx_memviewslice __pyx_v_theta, __Pyx_memviewslice __pyx_v_phi, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_sch, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_N;
  CYTHON_UNUSED Py_ssize_t __pyx_v_max_degree;
  PyObject *__pyx_v_field = NULL;
  __Pyx_memviewslice __pyx_v_field_memview = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_field_temp[3];
  int __pyx_v_i;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  Py_ssize_t __pyx_t_18;
  Py_ssize_t __pyx_t_19;
  __Pyx_RefNannySetupContext("internal_field_1darray", 0);

  /* "internal_field.pyx":65
 * cpdef internal_field_1darray(double[:] r, double[:] theta, double[:] phi, double[:,:] g, double[:,:] h, double[:,:] sch):
 * 
 *     cdef Py_ssize_t N = r.shape[0]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t max_degree = g.shape[0]
 ...
 */
  ...
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_N); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_field, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 69, __pyx_L1_error)
  __pyx_v_field_memview = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "internal_field.pyx":74
 *     cdef int i
 * 
 *     for i in range(N):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    } else if (unlikely(__pyx_t_9 >= __pyx_v_r.shape[0])) __pyx_t_10 = 0;
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_theta.shape[0];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_theta.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 75, __pyx_L1_error)
    }
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_phi.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_phi.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 75, __pyx_L1_error)
    }
    __pyx_t_1 = __pyx_f_14internal_field_internal_field((*((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_9 * __pyx_v_r.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_theta.data + __pyx_t_11 * __pyx_v_theta.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_phi.data + __pyx_t_12 * __pyx_v_phi.strides[0]) ))), __pyx_v_g, __pyx_v_h, __pyx_v_sch, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 75, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    if (unlikely(__Pyx_carray_from_py_double(__pyx_t_1, __pyx_t_13, 3) < 0)) __PYX_ERR(0, 75, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    memcpy(&(__pyx_v_field_temp[0]), __pyx_t_13, sizeof(__pyx_v_field_temp[0]) * (3));

    /* "internal_field.pyx":76
 *     for i in range(N):
 *         field_temp = internal_field(r[i], theta[i], phi[i], g, h, sch)
 *         field_memview[0,i] = field_temp[0]             # <<<<<<<<<<<<<<
 *         field_memview[1,i] = field_temp[1]
 ...
 */
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_field_memview.shape[0];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_field_memview.shape[0])) __pyx_t_10 = 0;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_field_memview.shape[1];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_10 = 1;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_field_memview.shape[1])) __pyx_t_10 = 1;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 76, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field_memview.data + __pyx_t_14 * __pyx_v_field_memview.strides[0]) ) + __pyx_t_15 * __pyx_v_field_memview.strides[1]) )) = (__pyx_v_field_temp[0]);

    /* "internal_field.pyx":77
 *         field_temp = internal_field(r[i], theta[i], phi[i], g, h, sch)
 *         field_memview[0,i] = field_temp[0]
 *         field_memview[1,i] = field_temp[1]             # <<<<<<<<<<<<<<
 *         field_memview[2,i] = field_temp[2]
 ...
 */
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_field_memview.shape[0];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_field_memview.shape[0])) __pyx_t_10 = 0;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_field_memview.shape[1];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_10 = 1;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_field_memview.shape[1])) __pyx_t_10 = 1;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 77, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field_memview.data + __pyx_t_16 * __pyx_v_field_memview.strides[0]) ) + __pyx_t_17 * __pyx_v_field_memview.strides[1]) )) = (__pyx_v_field_temp[1]);

    /* "internal_field.pyx":78
 *         field_memview[0,i] = field_temp[0]
 *         field_memview[1,i] = field_temp[1]
 *         field_memview[2,i] = field_temp[2]             # <<<<<<<<<<<<<<
 *     return field
 */
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_18 < 0) {
      __pyx_t_18 += __pyx_v_field_memview.shape[0];
      if (unlikely(__pyx_t_18 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_field_memview.shape[0])) __pyx_t_10 = 0;
    if (__pyx_t_19 < 0) {
      __pyx_t_19 += __pyx_v_field_memview.shape[1];
      if (unlikely(__pyx_t_19 < 0)) __pyx_t_10 = 1;
    } else if (unlikely(__pyx_t_19 >= __pyx_v_field_memview.shape[1])) __pyx_t_10 = 1;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 78, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field_memview.data + __pyx_t_18 * __pyx_v_field_memview.strides[0]) ) + __pyx_t_19 * __pyx_v_field_memview.strides[1]) )) = (__pyx_v_field_temp[2]);
  }

  /* "internal_field.pyx":79
 *         field_memview[1,i] = field_temp[1]
 *         field_memview[2,i] = field_temp[2]
 *     return field             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("internal_field.internal_field_1darray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_14internal_field_3internal_field_1darray(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14internal_field_3internal_field_1darray(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("internal_field_1darray (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_r,&__pyx_n_s_theta,&__pyx_n_s_phi,&__pyx_n_s_g,&__pyx_n_s_h,&__pyx_n_s_sch,0};
    PyObject* values[6] = {0,0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_theta)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("internal_field_1darray", 1, 6, 6, 1); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_phi)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field_1darray", 1, 6, 6, 2); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_g)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field_1darray", 1, 6, 6, 3); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field_1darray", 1, 6, 6, 4); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sch)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("internal_field_1darray", 1, 6, 6, 5); __PYX_ERR(0, 63, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "internal_field_1darray") < 0)) __PYX_ERR(0, 63, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 6) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_r.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_theta = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_theta.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_phi = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_phi.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_g = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_g.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_h = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_h.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_sch = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sch.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("internal_field_1darray", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 63, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("internal_field.internal_field_1darray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14internal_field_2internal_field_1darray(__pyx_self, __pyx_v_r, __pyx_v_theta, __pyx_v_phi, __pyx_v_g, __pyx_v_h, __pyx_v_sch);
...
static PyObject *__pyx_pf_14internal_field_2internal_field_1darray(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, __Pyx_memviewslice __pyx_v_theta, __Pyx_memviewslice __pyx_v_phi, __Pyx_memviewslice __pyx_v_g, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_sch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("internal_field_1darray", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_r.memview)) { __Pyx_RaiseUnboundLocalError("r"); __PYX_ERR(0, 63, __pyx_L1_error) }
  if (unlikely(!__pyx_v_theta.memview)) { __Pyx_RaiseUnboundLocalError("theta"); __PYX_ERR(0, 63, __pyx_L1_error) }
  if (unlikely(!__pyx_v_phi.memview)) { __Pyx_RaiseUnboundLocalError("phi"); __PYX_ERR(0, 63, __pyx_L1_error) }
  if (unlikely(!__pyx_v_g.memview)) { __Pyx_RaiseUnboundLocalError("g"); __PYX_ERR(0, 63, __pyx_L1_error) }
  if (unlikely(!__pyx_v_h.memview)) { __Pyx_RaiseUnboundLocalError("h"); __PYX_ERR(0, 63, __pyx_L1_error) }
  if (unlikely(!__pyx_v_sch.memview)) { __Pyx_RaiseUnboundLocalError("sch"); __PYX_ERR(0, 63, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14internal_field_internal_field_1darray(__pyx_v_r, __pyx_v_theta, __pyx_v_phi, __pyx_v_g, __pyx_v_h, __pyx_v_sch, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "internal_field.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "internal_field._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"internal_field", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14internal_field_1internal_field, METH_VARARGS|METH_KEYWORDS, 0},
  {"internal_field_1darray", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14internal_field_3internal_field_1darray, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_internal_field(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_internal_field},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "lpmv", (void (**)(void))&__pyx_f_5scipy_7special_14cython_special_lpmv, "double (double, double, double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initinternal_field(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initinternal_field(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_internal_field(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_internal_field(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_internal_field(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'internal_field' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_internal_field(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("internal_field", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_internal_field) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "internal_field")) {
      if (unlikely(PyDict_SetItemString(modules, "internal_field", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init internal_field", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init internal_field");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
